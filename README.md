...
- Код не запускался в среде с установленными PyQt6/PyVista/OpenCV (только
  синтаксическая проверка `py_compile`) — перед первым запуском стоит
  проверить совместимость версий VTK/PyVista с вашей ОС и GPU-драйверами.
